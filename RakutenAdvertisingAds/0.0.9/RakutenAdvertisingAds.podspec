...
Global Advertising Platform, mobile sdk for iOS
 ...
 s.subspec 'Video' do |subspec|
   ...
   subspec.dependency 'SWXMLHash', '~> 7.0.0'
 end

  s.subspec 'AdMobMediation' do |subspec|
    subspec.source_files = 'Source/Mediation/AdMob/**/*.swift'
    subspec.dependency 'RakutenAdvertisingAds/Core'
    subspec.dependency 'Google-Mobile-Ads-SDK', '~> 9.6.0'
  end
  
  s.subspec 'AdMobBidderMediation' do |subspec|
    subspec.source_files = 'Source/Mediation/AdMobBidderMediation/**/*.swift'
    subspec.dependency 'RakutenAdvertisingAds/Core'
    subspec.dependency 'RakutenAdvertisingAds/AdMobMediation'
  end
