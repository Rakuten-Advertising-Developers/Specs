...
Pod::Spec.new do |s|
  ...
  s.name             = 'GAPMobile'
  s.version          = '0.0.1'
  s.summary          = 'Rakuten Advertising Ads (Deprecated)'
...
Global Advertising Platform, mobile sdk for iOS
  ...
  s.source_files = 'src/GAPMobile/**/*.swift'
  
  s.static_framework = true
  
  s.dependency 'RakutenAdvertisingAds'
  s.dependency 'Google-Mobile-Ads-SDK', '~> 7.58.0'
  
  s.deprecated = true
  s.deprecated_in_favor_of = 'RakutenAdvertisingAds'
